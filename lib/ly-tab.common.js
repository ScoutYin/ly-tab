...
var tab_itemvue_type_template_id_aa3624b8_render = function () {
  ...
  return _c(
    ...
    [
      _c(
        "div",
        { staticClass: "ly-tab-item__wrap" },
        [
          _vm._t("icon"),
          _vm._v(" "),
          _c(
            "div",
            { staticClass: "ly-tab-item__label" },
            [
          ...
          _vm._v(" "),
          _vm.badge
            ? _c("div", { staticClass: "ly-tab-item__badge" }, [
                _vm._v("\n\t\t\t" + _vm._s(_vm.badge) + "\n\t\t"),
              ])
            : _vm._e(),
        ],
  ...
  return _c("div", { ref: "viewArea", staticClass: "ly-tabs" }, [
    _c(
      ...
      [
        ...
        _vm._v(" "),
        _c("div", {
          staticClass: "ly-tabs__active-line",
...
/* harmony default export */ var tabsvue_type_script_lang_js_ = ({
  ...
  computed: {
    ...
    activeBarStyle: function activeBarStyle() {
      return {
        ...
        height: "".concat(this.lineHeight, "px"),
        transform: "translate3d(".concat(this.lineOffset, "px, 0, 0)"),
  ...
  methods: {
    ...
    moveByInertia: function moveByInertia() {
      ...
      if (this.isMoveLeft) {
        ...
        if (this.translateX <= -this.offsetX) {
          // 加速度指数变化;
          this.acceleration *= (this.reBoundExponent + Math.abs(this.translateX + this.offsetX)) / this.reBoundExponent; // 为避免减速过程过短，此处加速度没有乘上frameTime;
     ...
     */
    calcLineOffset: function calcLineOffset() {
    ...
    getActiveItemEl: function getActiveItemEl() {
      ...
      var target = this.$children.find(function (child) {
...
var install = function install(Vue) {
  ...
  Vue.component(tab_bar.name, tab_bar);
};
